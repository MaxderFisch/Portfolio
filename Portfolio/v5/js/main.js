/**
 * V5 · Editorial Noir Refined — Main JavaScript
 * Basiert auf V4 (Nav, Galerie, Lightbox, Reveal, Fullscreen).
 * Layout-Feintuning erfolgte ausschließlich per CSS, JS unverändert.
 */
